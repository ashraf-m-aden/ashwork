                ...
                <div class="col-lg-6 col-md-12 services-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="box">
                                <feather type="database"></feather> Base de données Cloud
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="box">
                                <feather type="file"></feather> Stockage des fichiers
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="box">
                                <feather type="folder"></feather> Sauvegarde des fichiers
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="box">
                                <feather type="mail"></feather> Serveur de messagerie
                            </div>
                        </div>
                    </div>
                </div>
